...
export class LobbyScene extends Scene {
  ...
  create(data) {
    ...
    this.socket.on("connect", () => {
      console.log(
        "consoleLog: You've connected to rootSocket within the lobbyScene. Create/join a game!"
      );
    });
  ...
  handleJoinRoom(gameId) {
    ...
    this.socket.on("gameRoomCreated", (response) => {
      ...
      }); // Start game and pass player,socket, and gameId information to game scene.
    });
